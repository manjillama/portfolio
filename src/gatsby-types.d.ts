...
type GetFeaturedBlogsQuery = { readonly blogs: { readonly nodes: ReadonlyArray<{ readonly html: string | null, readonly id: string, readonly timeToRead: number | null, readonly excerpt: string | null, readonly frontmatter: { readonly date: string | null, readonly featured: boolean | null, readonly slug: string | null, readonly title: string | null, readonly featuredImage: { readonly childImageSharp: { readonly fluid: { readonly srcWebp: string | null } | null } | null } | null } | null }> } };
