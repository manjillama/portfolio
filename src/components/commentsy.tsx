        ...
        <div className="flex flex-wrap rounded-lg mb-4">
          <div className="lg:w-1/2 mb-4 lg:pr-20 flex flex-col justify-center">
            ...
            <p className="text-gray-600 text-sm mt-6 mb-12">
              &quot;Commentsy&quot; is an open-source service for developers, bloggers, and content creators looking to
              enhance their online presence and create a more interactive and engaging platform for their visitors. With
              its user-friendly features, it simplifies the process of code integration and commenting, saving time and
              effort while improving user interaction and collaboration.
            </p>
          </div>
