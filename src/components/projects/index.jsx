...
const PROJECTS = [
  {
    ...
    techStack: 'JavaScript, React/Redux, GraphQL, MySQL,Sequelize.js, Node/Express.js, SASS',
  ...
  },
  {
    ...
    techStack: 'JavaScript, React/Redux, MySQL, Sequelize.js, Node/Express.js, SASS, Elasticsearch',
    source: 'https://bit.ly/3a7zePd'
  },
  {
    category: 'Mobile App',
    title: 'Audio Book',
    body: 'A simple mobile audio book app created using expo react-native.',
    techStack: 'JavaScript, React Native, Redux, Expo',
    source: 'https://youtu.be/eALArnbyPIQ'
  },
  {
    category: 'Blogging',
    title: 'Blogging site',
  ...
  },
  {
    ...
    techStack: 'Tech stack - React, Redux, Node.js, Express.js, Sequelize, MySQL',
